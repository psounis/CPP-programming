/* cpp12.use_of_resolution_scope_operator.cpp */
...
king::king(string in_name, string in_realm):
    person(in_name)
{
    realm = in_realm; 
}
...
philosopher::philosopher(string in_name, string in_philosophy):
    person(in_name)
{
...
phil_king::phil_king(string in_name, string in_realm, string in_philosophy):
    king(in_name, in_realm), philosopher(in_name, in_philosophy)
{
}
...
{
    left<<right.philosopher::name<<endl;
